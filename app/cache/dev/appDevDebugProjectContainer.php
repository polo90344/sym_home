...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'xshare', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager50e56de4b3294_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager50e56de4b3294_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_50e56de4b3294.php';
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('D:\\Symfony\\src\\ZMB\\DataBundle\\Resources\\config\\doctrine' => 'ZMB\\DataBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'ZMB\\DataBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('ZMBDataBundle' => 'ZMB\\DataBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('D:/Symfony/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50e56de4b3294_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
     ...
     *
     * @return EntityManager50e56de4b3294_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ZMBHelloBundle' => 'ZMB\\HelloBundle\\ZMBHelloBundle',
                'BloggerBlogBundle' => 'Blogger\\BlogBundle\\BloggerBlogBundle',
                'ZMBDataBundle' => 'ZMB\\DataBundle\\ZMBDataBundle',
            ...
            'assetic.java.bin' => 'E:\\Toshiba_L537\\Java\\jre6\\bin\\java.EXE',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_50e56de4b3294.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50e56de4b3294_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
